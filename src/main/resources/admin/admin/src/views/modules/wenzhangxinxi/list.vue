                ...
                <el-row :gutter="20" class="slt"
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '帖子标题' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.wenzhangbiaoti" placeholder="帖子标题"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.wenzhangbiaoti" placeholder="帖子标题"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 0" v-model="searchForm.wenzhangbiaoti" placeholder="帖子标题"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item :label="contents.inputTitle == 1 ? '博主账号' : ''">
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1"
                                  prefix-icon="el-icon-search" v-model="searchForm.bozhuzhanghao" placeholder="博主账号"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2"
                                  suffix-icon="el-icon-search" v-model="searchForm.bozhuzhanghao" placeholder="博主账号"
                                  clearable></el-input>
                        <el-input v-if="contents.inputIcon == 0" v-model="searchForm.bozhuzhanghao" placeholder="博主账号"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item>
