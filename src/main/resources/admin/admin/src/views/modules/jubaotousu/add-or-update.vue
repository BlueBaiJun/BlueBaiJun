  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="舆情时间" prop="jubaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubaoshijian" label="舆情时间" prop="jubaoshijian">
              <el-input v-model="ruleForm.jubaoshijian" 
                placeholder="舆情时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="舆情内容" prop="jubaoneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jubaoneirong" label="舆情内容" prop="jubaoneirong">
                    <span>{{ruleForm.jubaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
